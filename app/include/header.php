        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
          <ul class="navbar-nav fs-5 fw-semibold">
            <li class="nav-item p-3 ms-md-3 mt-2">
              <a class="custom-font menu-link" aria-current="page" href="<?php echo BASE_URL ;?>">О нас</a>
            </li>
            <li class="nav-item p-3 ms-md-3 mt-2">
              <a class="custom-font menu-link" aria-current="page" href="https://t.me/formula_it">Услуги</a>
            </li>
            <li class="nav-item p-3 ms-md-3 mt-2">
