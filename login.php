    ...
    <div class="row justify-content-center">
      <div class="form-background justify-content-center d-inline-flex col-12 col-md-8 col-lg-6 p-5">
        <div class=" col-12 col-md-11 p-4 form-wrapper">
          <h2 class="fw-bolder mb-4">Вход</h2>
          ...
          <form method="post" action="login.php">
            ...
            <button class="sub-btn" type="submit" name="btn-log">Принять</button>
            <p class="mt-4 form-text">Ещё не зарегистрированы? <br> <a href="registration.php">Зарегистрироваться?</a></p>
